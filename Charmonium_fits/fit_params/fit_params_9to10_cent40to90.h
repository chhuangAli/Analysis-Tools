...
//-----------------------------------------------------------------
    ...
    double display_NJPsi_range = 250;
    double display_Sigma_range = 0.01;
...
double pp13_fit0_par2_CB2_VWG[] = {1.,-20.,20.};
double pp13_fit0_par3_CB2_VWG[] = {1.,-20.,20.};
...
double pp13_fit0_norm_psi2S_CB2_VWG[] = {0.1, 0, 0.8};
...
double pp13_fit1_norm_psi2S_CB2_pol[] = {0.1, -0.5, 0.5};
...
double pp13_fit0_norm_psi2S_CB2_exp[] = {0.1, 0., 0.5};

double pp13_fit1_par0_CB2_exp[] = {1.,0.,1000.}; // initial value, lower limit, upper limit
double pp13_fit1_par1_CB2_exp[] = {1.,0.,5.};
double pp13_fit1_par2_CB2_exp[] = {1.,0.,1000.};
...
double geant3_fit0_mean_jpsi_NA60_pol[] = {3.10, 3.07, 3.17};
...
double geant3_fit1_par3_NA60_pol[] = {1,-10.,10.};
...
double geant3_fit0_norm_psi2S_NA60_exp[] = {0.1, 0.0, 0.5};
