...
double pp13_fit0_norm_psi2S_CB2_pol[] = {0.1, 0, 1.5};
...
double geant3_fit0_par5_CB2_pol[] = {1,-50.,50.};
...
double geant3_fit0_norm_psi2S_CB2_pol[] = {0.1, 0, 1.0};
...
// Tail: geant3. Fit Range: 2.2 4.5
double geant3_fit0_par0_NA60_exp[] = {1.,0.,100000.}; // initial value, lower limit, upper limit
double geant3_fit0_par1_NA60_exp[] = {1.,0.,10.};
double geant3_fit0_par2_NA60_exp[] = {1.,0.,100000.};
