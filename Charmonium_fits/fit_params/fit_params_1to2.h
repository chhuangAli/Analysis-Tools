...
double pp13_fit0_par1_CB2_VWG[] = {1.,-5.,5.};
...
double geant3_fit0_par6_CB2_pol[] = {0.1,-5.,5.};
...
// Tail: geant3. Fit Range: 2.2 4.5
double geant3_fit0_par0_NA60_pol[] = {1.,0.,15.}; // initial value, lower limit, upper limit
