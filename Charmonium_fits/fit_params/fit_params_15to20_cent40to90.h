...
//-----------------------------------------------------------------
    ...
    double display_NJPsi_range = 100;
    double display_Sigma_range = 0.1;
    double display_Mass_range = 0.1;
...
double pp13_fit0_norm_psi2S_CB2_VWG[] = {0.1, 0.0, 0.8};
...
double geant3_fit0_par0_CB2_VWG[] = {1.,0.,15.}; // initial value, lower limit, upper limit
...
double geant3_fit1_par3_CB2_VWG[] = {0.1,-50.,50.};
double geant3_fit1_par4_CB2_VWG[] = {0.1,-50, 50.};
...
double geant3_fit1_mean_jpsi_CB2_VWG[] = {3.10, 3.07, 3.15};
...
double pp13_fit1_par1_CB2_pol[] = {5,-10.,10.};
double pp13_fit1_par2_CB2_pol[] = {5,-10.,10.};
double pp13_fit1_par3_CB2_pol[] = {1,-50,50.};
double pp13_fit1_par4_CB2_pol[] = {1,-50.,50.};
...
//Tail: geant3. Fit Range: 2.2 4.5
double geant3_fit0_par0_CB2_pol[] = {1.,0.,20.}; // initial value, lower limit, upper limit
...
double geant3_fit0_par4_CB2_pol[] = {1,-50.,50.};
...
double geant3_fit0_mean_jpsi_CB2_pol[] = {3.10, 3.07, 3.2};
...
double geant3_fit1_width_jpsi_CB2_pol[] = {0.07, 0.04, 0.1};
...
double pp13_fit1_norm_psi2S_CB2_exp[] = {0.1, -0.05, 0.5};
...
double geant3_fit0_par1_NA60_VWG[] = {5, -10.,10.}; //2.5,0.,8.
double geant3_fit0_par2_NA60_VWG[] = {5, -10.,10.}; // 1.,-5.,5.
double geant3_fit0_par3_NA60_VWG[] = {5, -10.,10.}; // 1.,-5.,5.
double geant3_fit0_par4_NA60_VWG[] = {5, -10.,10.}; // 1.,-5.,5.
...
double geant3_fit1_par1_NA60_VWG[] = {5, -50.,50.};
double geant3_fit1_par2_NA60_VWG[] = {5, -10.,10.};
double geant3_fit1_par3_NA60_VWG[] = {0.1, -20.,20.};
double geant3_fit1_par4_NA60_VWG[] = {0.1, -60.,60.};
...
double geant3_fit0_par4_NA60_pol[] = {1,-50.,50.};
...
double geant3_fit0_mean_jpsi_NA60_pol[] = {3.10, 3.07, 3.2};
...
double geant3_fit1_par1_NA60_pol[] = {5,-10.,10.};
...
// Tail: geant3. Fit Range: 2.4 4.7
double geant3_fit1_par0_NA60_exp[] = {1000.,0,10000.}; // initial value, lower limit, upper limit
double geant3_fit1_par1_NA60_exp[] = {1,0.,10.};
double geant3_fit1_par2_NA60_exp[] = {1000,0.,10000.};
