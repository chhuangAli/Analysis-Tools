...
double geant3_fit0_par6_NA60_pol[] = {1,-10.,10.};
...
// Tail: geant3. Fit Range: 2.2 4.5
double geant3_fit0_par0_NA60_exp[] = {1.,0.,1000.}; // initial value, lower limit, upper limit
double geant3_fit0_par1_NA60_exp[] = {1, 0.,5.};
double geant3_fit0_par2_NA60_exp[] = {1.,0.,1000.};
