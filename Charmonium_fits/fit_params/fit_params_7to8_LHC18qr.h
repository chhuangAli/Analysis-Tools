...
double geant3_fit1_par2_CB2_VWG[] = {1,-5.,5.};
...
//Tail: pp13TeV. Fit Range: 2.2 4.4
double pp13_fit1_par0_CB2_pol[] = {0.1,0.,10.}; // initial value, lower limit, upper limit
...
double pp13_fit1_norm_psi2S_CB2_pol[] = {0.1, 0, 0.8};
