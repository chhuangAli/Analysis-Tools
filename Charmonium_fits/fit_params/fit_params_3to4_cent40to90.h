...
//-----------------------------------------------------------------
    ...
    double display_NJPsi_range = 5000;
...
double pp13_fit1_norm_psi2S_CB2_VWG[] = {0.1, -0.05, 0.5};
...
double geant3_fit1_par0_CB2_VWG[] = {1.,0.,5.}; // initial value, lower limit, upper limit
double geant3_fit1_par1_CB2_VWG[] = {0.1, -10.,10.};
double geant3_fit1_par2_CB2_VWG[] = {0.1, -10.,10.};
double geant3_fit1_par3_CB2_VWG[] = {0.1, -100.,100.};
double geant3_fit1_par4_CB2_VWG[] = {0.1, -100.,100.};
...
double pp13_fit1_par6_CB2_pol[] = {0.1,-50.,50.};
...
double geant3_fit0_par1_CB2_pol[] = {0.1,-100.,100.}; // 1.,-10000.,10000.
double geant3_fit0_par2_CB2_pol[] = {0.1,-100.,100.};
double geant3_fit0_par3_CB2_pol[] = {0.1,-100.,100.}; // 1.,-10000.,10000.
double geant3_fit0_par4_CB2_pol[] = {0.1,-100.,100.};
double geant3_fit0_par5_CB2_pol[] = {0.1,-100.,100.};
...
double geant3_fit1_par6_CB2_pol[] = {1,-10.,10.};
...
double geant3_fit1_norm_psi2S_CB2_pol[] = {0.1, -0.05, 0.5};
...
double pp13_fit0_par2_CB2_exp[] = {1, 0.,10000.};
...
double pp13_fit1_par1_CB2_exp[] = {0.1,0.,10.};
double pp13_fit1_par2_CB2_exp[] = {1.,0.,10000.};
double pp13_fit1_par3_CB2_exp[] = {0.1,0.,10.};
...
double geant3_fit0_par1_CB2_exp[] = {0.1, 0.,10.};
double geant3_fit0_par2_CB2_exp[] = {1, 0.,100000.};
double geant3_fit0_par3_CB2_exp[] = {0.1, 0.,10.};
...
double geant3_fit0_mean_jpsi_CB2_exp[] = {3.10, 3.07, 3.20};
...
// Tail: geant3. Fit Range: 2.2 4.5
double geant3_fit0_par0_NA60_VWG[] = {1, 0, 5.}; // initial value, lower limit, upper limit
double geant3_fit0_par1_NA60_VWG[] = {0.1, -100.,100.}; //2.5,0.,8.
double geant3_fit0_par2_NA60_VWG[] = {0.1, -100.,100.}; // 1.,-5.,5.
double geant3_fit0_par3_NA60_VWG[] = {0.1, -100.,100.}; // 1.,-5.,5.
double geant3_fit0_par4_NA60_VWG[] = {0.1, -100.,100.}; // 1.,-5.,5.
...
double geant3_fit1_norm_psi2S_NA60_VWG[] = {0.1, 0, 1.0};
...
double geant3_fit0_par6_NA60_pol[] = {0.1,-10.,10.};
...
double geant3_fit1_par1_NA60_pol[] = {0.1,-100.,100.};
...
// Tail: geant3. Fit Range: 2.4 4.7
double geant3_fit1_par0_NA60_exp[] = {1.,0,1000.}; // initial value, lower limit, upper limit
double geant3_fit1_par1_NA60_exp[] = {1,0.,10.};
double geant3_fit1_par2_NA60_exp[] = {1,0.,1000.};
