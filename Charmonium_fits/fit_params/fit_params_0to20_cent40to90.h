...
double geant3_fit0_norm_psi2S_CB2_pol[] = {0.1, 0.0, 0.5};
...
double geant3_fit1_mean_jpsi_CB2_pol[] = {3.10, 3.07, 3.2};
...
double geant3_fit0_par1_NA60_exp[] = {1.,0.,25.};
double geant3_fit0_par2_NA60_exp[] = {1.,0.,1000000.};
