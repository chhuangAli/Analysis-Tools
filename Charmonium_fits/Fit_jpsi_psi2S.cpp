...
#include "read_access_subtracted_histos.h"
#include "read_access_histos_y_dependence.h"

//#include "fit_params/fit_params_0to0p3.h"
//#include "fit_params/fit_params_0to0p3_cent20to40.h"
//#include "fit_params/fit_params_0to0p3_cent40to90.h"
//#include "fit_params/fit_params_0p3to1.h"
//#include "fit_params/fit_params_0p3to1_cent20to40.h"
//#include "fit_params/fit_params_0p3to1_cent40to90.h"
//#include "fit_params/fit_params_0p3to1_LHC15o.h"
//#include "fit_params/fit_params_1to2.h"
//#include "fit_params/fit_params_1to2_cent20to40.h"
//#include "fit_params/fit_params_1to2_cent40to90.h"
//#include "fit_params/fit_params_2to3.h"
//#include "fit_params/fit_params_2to3_cent20to40.h"
//#include "fit_params/fit_params_2to3_cent40to90.h"
//#include "fit_params/fit_params_3to4.h"
//#include "fit_params/fit_params_3to4_cent20to40.h"
//#include "fit_params/fit_params_3to4_cent40to90.h"
//#include "fit_params/fit_params_4to5.h"
//#include "fit_params/fit_params_4to5_cent20to40.h"
//#include "fit_params/fit_params_4to5_cent40to90.h"
//#include "fit_params/fit_params_5to6.h"
//#include "fit_params/fit_params_5to6_cent20to40.h"
//#include "fit_params/fit_params_5to6_cent40to90.h"
//#include "fit_params/fit_params_6to7.h"
//#include "fit_params/fit_params_6to7_cent20to40.h"
//#include "fit_params/fit_params_6to7_cent40to90.h"
//#include "fit_params/fit_params_7to8.h"
//#include "fit_params/fit_params_7to8_cent20to40.h"
//#include "fit_params/fit_params_7to8_cent40to90.h"
//#include "fit_params/fit_params_7to8_LHC18qr.h"
//#include "fit_params/fit_params_8to9.h"
//#include "fit_params/fit_params_8to9_cent20to40.h"
//#include "fit_params/fit_params_8to9_cent40to90.h"
//#include "fit_params/fit_params_8to9_LHC15o.h"
//#include "fit_params/fit_params_9to10.h"
//#include "fit_params/fit_params_9to10_cent20to40.h"
//#include "fit_params/fit_params_9to10_cent40to90.h"
//#include "fit_params/fit_params_10to11.h"
//#include "fit_params/fit_params_10to11_cent20to40.h"
//#include "fit_params/fit_params_10to11_cent40to90.h"
//#include "fit_params/fit_params_11to12.h"
//#include "fit_params/fit_params_11to12_cent20to40.h"
//#include "fit_params/fit_params_11to12_cent40to90.h"
//#include "fit_params/fit_params_12to15.h"
//#include "fit_params/fit_params_12to15_LHC15o.h"
//#include "fit_params/fit_params_12to15_cent20to40.h"
//#include "fit_params/fit_params_12to15_cent40to90.h"
//#include "fit_params/fit_params_15to20.h"
//#include "fit_params/fit_params_15to20_cent20to40.h"
//#include "fit_params/fit_params_15to20_cent40to90.h"
#include "fit_params/fit_params_0to20.h"
//#include "fit_params/fit_params_0to20_cent20to40.h"
//#include "fit_params/fit_params_0to20_cent40to90.h"

//#include "fit_params/fit_params_2p5to2p75.h"
//#include "fit_params/fit_params_2p75to3.h"
//#include "fit_params/fit_params_3to3p25.h"
//#include "fit_params/fit_params_3p25to3p5.h"
//#include "fit_params/fit_params_3p5to3p75.h"
//#include "fit_params/fit_params_3p75to4.h"

//#include "fit_params/LHC18qr/fit_params_0to20.h"
//#include "fit_params/LHC18qr/fit_params_0to12.h"
//#include "fit_params/LHC15o/fit_params_0to12.h"
...
//For subtracted fit
    ...
    histoSubRawInvM->SetAxisRange(2,5,"X");

    TH1F *histoSubInvMass_Pt12to15 = new TH1F(Form("histoSubInvMass_Merged_Pt12to15"), Form("dimuon invariant mass distribution vs Pt12to15; M_{#mu#mu} (GeV/c^{2}); Events per %g GeV", (upperLimit_histoInvMass-lowerLimit_histoInvMass)/NUMOFBINS ), NUMOFBINS,lowerLimit_histoInvMass,upperLimit_histoInvMass);
      histoSubInvMass_Pt12to15->Sumw2();
      histoSubInvMass_Pt12to15->SetAxisRange(2,5,"X");

    TH1F *histoSubInvMass_Pt15to20 = new TH1F(Form("histoSubInvMass_Merged_Pt15to20"), Form("dimuon invariant mass distribution vs Pt15to20; M_{#mu#mu} (GeV/c^{2}); Events per %g GeV",(upperLimit_histoInvMass-lowerLimit_histoInvMass)/NUMOFBINS ), NUMOFBINS,lowerLimit_histoInvMass,upperLimit_histoInvMass);
      histoSubInvMass_Pt15to20->Sumw2();


    TH1F *histoSubInvMass[numberOfPtBins_photon];
    for(int iPt =0; iPt < (numberOfPtBins_photon); iPt++)
    {
         histoSubInvMass[iPt] = new TH1F(Form("histoSubInvMass_Pt%gto%g", arrayAvailablePtBins_photon[iPt], arrayAvailablePtBins_photon[iPt+1]), Form("; m_{#mu#mu} (GeV/c^{2}); Events per %g GeV", (upperLimit_histoInvMass-lowerLimit_histoInvMass)/NUMOFBINS ), NUMOFBINS, lowerLimit_histoInvMass, upperLimit_histoInvMass);
         histoSubInvMass[iPt]->Sumw2();
         histoSubInvMass[iPt]->SetAxisRange(2,5,"X");
    }
...
/*
    TH1F *histoInvMass[numberOfYBins];
    for(int iY =0; iY < (numberOfYBins); iY++)
    {
         histoInvMass[iY] = new TH1F(Form("histoInvMass_Y%gto%g", arrayAvailableYBins[iY], arrayAvailableYBins[iY+1]), Form("; m_{#mu#mu} (GeV/c^{2}); Events per %g GeV", (upperLimit_histoInvMass-lowerLimit_histoInvMass)/NUMOFBINS ), NUMOFBINS, lowerLimit_histoInvMass, upperLimit_histoInvMass);
         histoInvMass[iY]->Sumw2();
         histoInvMass[iY]->SetAxisRange(2,5,"X");
    }
...
//          directory = "$HOME/local/anaedPbPbData2018/LHC18q_r/muon_calo_pass3/AOD225_CMULEvent_AnaResults_Pcorr/";
        ...
        {
          directory = "$HOME/local/anaedPbPbData2015/LHC15o/muon_calo_pass1/AOD229_CMULEvent_AnaResults/";          
          name = "DimuonResultsHistos_LHC15o.root";

//          directory = "$HOME/local/anaedPbPbData2015/CMULEvent_AnaResults/v4/";
//          name = "CMUL_totEvents_v4.root";
        }
        else
        {
          break;
      ...
      for(int iFile=0; iFile<2; iFile++)
      {
        ...
        if(iFile ==0)
        {
          directory = "$HOME/cernbox/AnaSourceCode/anaJPsi_2018PbPb/mixed-event_method/makeNormalizedHistos/";
          name = "ResultsNormalized_LHC18qr.root";
        }
        else if(iFile ==1)
        {
          directory = "$HOME/cernbox/AnaSourceCode/anaJPsi_2018PbPb/mixed-event_method/makeNormalizedHistos/";
          name = "ResultsNormalized.root";
        }
        else
        {
          break;
        ...
        read_access_subtracted_histos(inputFile, init_pt, init_cent, end_cent, histoSubInvMass, histoSubRawInvM);
    ...
    {
        path_to_histos = Form("$HOME/cernbox/AnaSourceCode/anaJPsi_2015_2018PbPb/mixed-event_method/check_ds_factor_effect_CMLLonly/CMLLonly_mass_spectra.root");
        TFile *inputFile = new TFile(path_to_histos,"READ");
//        read_access_histos(inputFile, init_pt, histoInvMass, histoRawInvM);
        histoRawInvM->Add((TH1F*) inputFile->Get( Form("DimuonHistos/histoNJpsi_cent0to20") ) ); 
        histoSubRawInvM->Add((TH1F*) inputFile->Get( Form("DimuonHistos/histoNJpsi_cent0to20") ) );
...
//  if(pt_bin >=11)
  {
    ...
    histoSubInvMass[pt_bin]->Rebin();
    histoSubInvMass[pt_bin]->SetAxisRange(2,5,"X");
//     nbin = histoSubInvMass[pt_bin]->GetNbinsX();
//    _xmin = histoSubInvMass[pt_bin]->GetXaxis()->GetBinLowEdge(1);
//    _xmax = histoSubInvMass[pt_bin]->GetXaxis()->GetBinUpEdge(nbin);
//    binWidth = (_xmax-_xmin)/nbin;
...
//  paramCB2Pol2[2].strNameOfFitFunc = "fitFuncCB2Pol_geant3"; 
  ...
  struct paramOfFunc paramCB2Exp[NUMOFTAILPARAM_CB2];
  paramCB2Exp[0].strNameOfFitFunc = "fitFuncCB2Exp_pp13";
  paramCB2Exp[1].strNameOfFitFunc = "fitFuncCB2Exp_geant3"; 
  ...
  double Njpsi_CB2Exp[FITRANGE][NUMOFTAILPARAM_CB2][NUMOFCENT_BINS];
  double SigmaJpsi_CB2Exp[FITRANGE][NUMOFTAILPARAM_CB2][NUMOFCENT_BINS];
  double MassJpsi_CB2Exp[FITRANGE][NUMOFTAILPARAM_CB2][NUMOFCENT_BINS];
  double ChiJpsi_CB2Exp[FITRANGE][NUMOFTAILPARAM_CB2][NUMOFCENT_BINS];
  double ErrorOfNjpsi_CB2Exp[FITRANGE][NUMOFTAILPARAM_CB2][NUMOFCENT_BINS];
  double ErrorOfSigmaJpsi_CB2Exp[FITRANGE][NUMOFTAILPARAM_CB2][NUMOFCENT_BINS];
  double ErrorOfMassJpsi_CB2Exp[FITRANGE][NUMOFTAILPARAM_CB2][NUMOFCENT_BINS];
  double ErrorOfChiJpsi_CB2Exp[FITRANGE][NUMOFTAILPARAM_CB2][NUMOFCENT_BINS];
  ...
  for (int iTail=0; iTail < NUMOFTAILPARAM_CB2; iTail++)
  {
    ...
    // initialize the struct for CB2 + Exp
    paramCB2Exp[iTail].binWidth = binWidth;
    paramCB2Exp[iTail].NumOfBackGroundFuncParams = numOfExp_Parm;
    paramCB2Exp[iTail].NumOfJPsiSignalFuncParams = numOfCB2_Parm+1;

    paramCB2Exp[iTail].NameOfBackGroundFuncParams = new TString[numOfExp_Parm];
    for (int iName=0; iName<numOfExp_Parm; iName++) paramCB2Exp[iTail].NameOfBackGroundFuncParams[iName].Append(NameOfExpFuncParams[iName].Data());

    paramCB2Exp[iTail].NameOfJPsiSignalFuncParams = new TString[numOfCB2_Parm+1];
    for (int iName=0; iName<numOfCB2_Parm+1; iName++) paramCB2Exp[iTail].NameOfJPsiSignalFuncParams[iName].Append(NameOfDoubleCB2FuncParams[iName].Data());

    paramCB2Exp[iTail].ParamJPsiFunc = new double[numOfCB2_Parm+1];

 }

// Sign the fixed signal parameters
...
//    paramCB2Pol2[2].ParamJPsiFunc[iParam] = Param_doubleCB2_geant3[iParam];
    ...
    paramCB2Exp[0].ParamJPsiFunc[iParam] = Param_doubleCB2_ppdata[iParam];
    paramCB2Exp[1].ParamJPsiFunc[iParam] = Param_doubleCB2_geant3[iParam];
  }
...
//  const double FitRange[FITRANGE][2] = {{2.0,4.8},{2.2,4.4}};  
  ...
  const int FIT_NUMBER_CB2 = FITRANGE * NUMOFBACKGROUNDFUNC*  NUMOFTAILPARAM_CB2 * 1 ; // 3 is for the number of background functions
...
//                      fitCanvas_background[iCount1],
                      ...
                      std::cout << "fit chi2: " << outcome_fit.chi2 << std::endl;
...
//      paramCB2VWG[iTail].fitRange[iRange][1]=FitRange[iRange][1];
      ...
      const int numOfCB2Exp_Param = numOfExp_Parm + numOfCB2_Parm;      

    if(iTail==0 && iRange == 0) // Tail: pp13TeV. Fit Range: 2.0 4.8
    {
      //paramCB2VWG[iTail].strNameOfFitFunc = Form("fitFuncCB2VWG_pp13_%i_%i", iTail, iRange);
      for(int iParam=0; iParam<numOfCB2_Parm; iParam++) paramCB2VWG[iTail].ParamJPsiFunc[iParam] = Param_doubleCB2_ppdata[iParam];
      paramCB2Exp[iTail].paramsInitialExp2[0]= pp13_fit0_par0_CB2_exp[0];
      paramCB2Exp[iTail].paramsLimitExp2[0][0] = pp13_fit0_par0_CB2_exp[1];
      paramCB2Exp[iTail].paramsLimitExp2[0][1] = pp13_fit0_par0_CB2_exp[2];
  
      //background function fit
      paramCB2Exp[iTail].paramsInitialExp2[1] = pp13_fit0_par1_CB2_exp[0]; 
      paramCB2Exp[iTail].paramsLimitExp2[1][0] = pp13_fit0_par1_CB2_exp[1];
      paramCB2Exp[iTail].paramsLimitExp2[1][1] = pp13_fit0_par1_CB2_exp[2];

      paramCB2Exp[iTail].paramsInitialExp2[2] = pp13_fit0_par2_CB2_exp[0];
      paramCB2Exp[iTail].paramsLimitExp2[2][0] = pp13_fit0_par2_CB2_exp[1];
      paramCB2Exp[iTail].paramsLimitExp2[2][1] = pp13_fit0_par2_CB2_exp[2];

      paramCB2Exp[iTail].paramsInitialExp2[3] = pp13_fit0_par3_CB2_exp[0];
      paramCB2Exp[iTail].paramsLimitExp2[3][0] = pp13_fit0_par3_CB2_exp[1];
      paramCB2Exp[iTail].paramsLimitExp2[3][1] = pp13_fit0_par3_CB2_exp[2];
      
//      paramCB2Exp[iTail].paramsInitialExp2[4] = pp13_fit0_par4_CB2_VWG[0];
//      paramCB2Exp[iTail].paramsLimitVWG[4][0] = pp13_fit0_par4_CB2_VWG[1];
//      paramCB2Exp[iTail].paramsLimitVWG[4][1] = pp13_fit0_par4_CB2_VWG[2];


      //background function + signal function fit. If the above range is not nice, adjust the range here.
      paramCB2Exp[iTail].paramsVarianceExp2[1] = pp13_fit0_par1_variance_CB2_exp[0];
      paramCB2Exp[iTail].paramsLimitVarianceExp2[1][0] = pp13_fit0_par1_variance_CB2_exp[1];
      paramCB2Exp[iTail].paramsLimitVarianceExp2[1][1] = pp13_fit0_par1_variance_CB2_exp[2];

      paramCB2Exp[iTail].paramsVarianceExp2[2] = pp13_fit0_par2_variance_CB2_exp[0];
      paramCB2Exp[iTail].paramsLimitVarianceExp2[2][0] = pp13_fit0_par2_variance_CB2_exp[1];
      paramCB2Exp[iTail].paramsLimitVarianceExp2[2][1] = pp13_fit0_par2_variance_CB2_exp[2];

      paramCB2Exp[iTail].paramsVarianceExp2[3] = pp13_fit0_par3_variance_CB2_exp[0];
      paramCB2Exp[iTail].paramsLimitVarianceExp2[3][0] = pp13_fit0_par3_variance_CB2_exp[1];
      paramCB2Exp[iTail].paramsLimitVarianceExp2[3][1] = pp13_fit0_par3_variance_CB2_exp[2];

//      paramCB2Exp[iTail].paramsVarianceVWG[4] = pp13_fit0_par4_variance_CB2_VWG[0];
//      paramCB2Exp[iTail].paramsLimitVarianceVWG[4][0] = pp13_fit0_par4_variance_CB2_VWG[1];
//      paramCB2Exp[iTail].paramsLimitVarianceVWG[4][1] = pp13_fit0_par4_variance_CB2_VWG[2];

      paramCB2Exp[iTail].mean_jpsi = pp13_fit0_mean_jpsi_CB2_exp[0];
      paramCB2Exp[iTail].mean_LowerLimits_jpsi = pp13_fit0_mean_jpsi_CB2_exp[1];
      paramCB2Exp[iTail].mean_UpperLimits_jpsi = pp13_fit0_mean_jpsi_CB2_exp[2];

      paramCB2Exp[iTail].width_jpsi = pp13_fit0_width_jpsi_CB2_exp[0];
      paramCB2Exp[iTail].width_LowerLimits_jpsi = pp13_fit0_width_jpsi_CB2_exp[1];
      paramCB2Exp[iTail].width_UpperLimits_jpsi = pp13_fit0_width_jpsi_CB2_exp[2];

      paramCB2Exp[iTail].Norm_psi2S = pp13_fit0_norm_psi2S_CB2_exp[0];
      paramCB2Exp[iTail].LowerLimits_psi2S = pp13_fit0_norm_psi2S_CB2_exp[1];
      paramCB2Exp[iTail].UpperLimits_psi2S = pp13_fit0_norm_psi2S_CB2_exp[2];
    ...
    if(iTail==0 && iRange == 1) // Tail: pp13TeV. Fit Range: 2.4 4.4
    {
      ...
      paramCB2Exp[iTail].paramsInitialExp2[0]= pp13_fit1_par0_CB2_exp[0];
      paramCB2Exp[iTail].paramsLimitExp2[0][0] = pp13_fit1_par0_CB2_exp[1];
      paramCB2Exp[iTail].paramsLimitExp2[0][1] = pp13_fit1_par0_CB2_exp[2];

      paramCB2Exp[iTail].paramsInitialExp2[1] = pp13_fit1_par1_CB2_exp[0];
      paramCB2Exp[iTail].paramsLimitExp2[1][0] = pp13_fit1_par1_CB2_exp[1];
      paramCB2Exp[iTail].paramsLimitExp2[1][1] = pp13_fit1_par1_CB2_exp[2];

      paramCB2Exp[iTail].paramsInitialExp2[2] = pp13_fit1_par2_CB2_exp[0];
      paramCB2Exp[iTail].paramsLimitExp2[2][0] = pp13_fit1_par2_CB2_exp[1];
      paramCB2Exp[iTail].paramsLimitExp2[2][1] = pp13_fit1_par2_CB2_exp[2];

      paramCB2Exp[iTail].paramsInitialExp2[3] = pp13_fit1_par3_CB2_exp[0];
      paramCB2Exp[iTail].paramsLimitExp2[3][0] = pp13_fit1_par3_CB2_exp[1];
      paramCB2Exp[iTail].paramsLimitExp2[3][1] = pp13_fit1_par3_CB2_exp[2];

//      paramCB2Exp[iTail].paramsInitialVWG[4] = pp13_fit1_par4_CB2_VWG[0];
//      paramCB2Exp[iTail].paramsLimitVWG[4][0] = pp13_fit1_par4_CB2_VWG[1];
//      paramCB2Exp[iTail].paramsLimitVWG[4][1] = pp13_fit1_par4_CB2_VWG[2];

      paramCB2Exp[iTail].paramsVarianceExp2[1] = pp13_fit1_par1_variance_CB2_exp[0];
      paramCB2Exp[iTail].paramsLimitVarianceExp2[1][0] = pp13_fit1_par1_variance_CB2_exp[1];
      paramCB2Exp[iTail].paramsLimitVarianceExp2[1][1] = pp13_fit1_par1_variance_CB2_exp[2];

      paramCB2Exp[iTail].paramsVarianceExp2[2] = pp13_fit1_par2_variance_CB2_exp[0];
      paramCB2Exp[iTail].paramsLimitVarianceExp2[2][0] = pp13_fit1_par2_variance_CB2_exp[1];
      paramCB2Exp[iTail].paramsLimitVarianceExp2[2][1] = pp13_fit1_par2_variance_CB2_exp[2];

      paramCB2Exp[iTail].paramsVarianceExp2[3] = pp13_fit1_par3_variance_CB2_exp[0];
      paramCB2Exp[iTail].paramsLimitVarianceExp2[3][0] = pp13_fit1_par3_variance_CB2_exp[1];
      paramCB2Exp[iTail].paramsLimitVarianceExp2[3][1] = pp13_fit1_par3_variance_CB2_exp[2];

//      paramCB2Exp[iTail].paramsVarianceVWG[4] = pp13_fit1_par4_variance_CB2_VWG[0];
//      paramCB2Exp[iTail].paramsLimitVarianceVWG[4][0] = pp13_fit1_par4_variance_CB2_VWG[1];
//      paramCB2Exp[iTail].paramsLimitVarianceVWG[4][1] = pp13_fit1_par4_variance_CB2_VWG[2];

      paramCB2Exp[iTail].mean_jpsi = pp13_fit1_mean_jpsi_CB2_exp[0];
      paramCB2Exp[iTail].mean_LowerLimits_jpsi = pp13_fit1_mean_jpsi_CB2_exp[1];
      paramCB2Exp[iTail].mean_UpperLimits_jpsi = pp13_fit1_mean_jpsi_CB2_exp[2];

      paramCB2Exp[iTail].width_jpsi = pp13_fit1_width_jpsi_CB2_exp[0];
      paramCB2Exp[iTail].width_LowerLimits_jpsi = pp13_fit1_width_jpsi_CB2_exp[1];
      paramCB2Exp[iTail].width_UpperLimits_jpsi = pp13_fit1_width_jpsi_CB2_exp[2];

      paramCB2Exp[iTail].Norm_psi2S = pp13_fit1_norm_psi2S_CB2_exp[0];
      paramCB2Exp[iTail].LowerLimits_psi2S = pp13_fit1_norm_psi2S_CB2_exp[1];
      paramCB2Exp[iTail].UpperLimits_psi2S = pp13_fit1_norm_psi2S_CB2_exp[2];
     ...
     if(iTail==1 && iRange==0) 
    {
       ...
       paramCB2Exp[iTail].paramsInitialExp2[0]= geant3_fit0_par0_CB2_exp[0];
       paramCB2Exp[iTail].paramsLimitExp2[0][0] = geant3_fit0_par0_CB2_exp[1];
       paramCB2Exp[iTail].paramsLimitExp2[0][1] = geant3_fit0_par0_CB2_exp[2];

       paramCB2Exp[iTail].paramsInitialExp2[1] = geant3_fit0_par1_CB2_exp[0];
       paramCB2Exp[iTail].paramsLimitExp2[1][0] = geant3_fit0_par1_CB2_exp[1];
       paramCB2Exp[iTail].paramsLimitExp2[1][1] = geant3_fit0_par1_CB2_exp[2];

       paramCB2Exp[iTail].paramsInitialExp2[2] = geant3_fit0_par2_CB2_exp[0];
       paramCB2Exp[iTail].paramsLimitExp2[2][0] = geant3_fit0_par2_CB2_exp[1];
       paramCB2Exp[iTail].paramsLimitExp2[2][1] = geant3_fit0_par2_CB2_exp[2];

       paramCB2Exp[iTail].paramsInitialExp2[3] = geant3_fit0_par3_CB2_exp[0];
       paramCB2Exp[iTail].paramsLimitExp2[3][0] = geant3_fit0_par3_CB2_exp[1];
       paramCB2Exp[iTail].paramsLimitExp2[3][1] = geant3_fit0_par3_CB2_exp[2];

//       paramCB2Exp[iTail].paramsInitialVWG[4] = geant3_fit0_par4_CB2_VWG[0];
//       paramCB2Exp[iTail].paramsLimitVWG[4][0] = geant3_fit0_par4_CB2_VWG[1];
//       paramCB2Exp[iTail].paramsLimitVWG[4][1] = geant3_fit0_par4_CB2_VWG[2];

       paramCB2Exp[iTail].mean_jpsi = geant3_fit0_mean_jpsi_CB2_exp[0];
       paramCB2Exp[iTail].mean_LowerLimits_jpsi = geant3_fit0_mean_jpsi_CB2_exp[1];
       paramCB2Exp[iTail].mean_UpperLimits_jpsi = geant3_fit0_mean_jpsi_CB2_exp[2];

       paramCB2Exp[iTail].width_jpsi = geant3_fit0_width_jpsi_CB2_exp[0];
       paramCB2Exp[iTail].width_LowerLimits_jpsi = geant3_fit0_width_jpsi_CB2_exp[1];
       paramCB2Exp[iTail].width_UpperLimits_jpsi = geant3_fit0_width_jpsi_CB2_exp[2];

       paramCB2Exp[iTail].Norm_psi2S = geant3_fit0_norm_psi2S_CB2_exp[0];
       paramCB2Exp[iTail].LowerLimits_psi2S = geant3_fit0_norm_psi2S_CB2_exp[1];
       paramCB2Exp[iTail].UpperLimits_psi2S = geant3_fit0_norm_psi2S_CB2_exp[2];
     ...
     if(iTail==1 && iRange==1) 
     {
       ...
       paramCB2Exp[iTail].paramsInitialExp2[0]= geant3_fit1_par0_CB2_exp[0];
       paramCB2Exp[iTail].paramsLimitExp2[0][0] = geant3_fit1_par0_CB2_exp[1];
       paramCB2Exp[iTail].paramsLimitExp2[0][1] = geant3_fit1_par0_CB2_exp[2];

       paramCB2Exp[iTail].paramsInitialExp2[1] = geant3_fit1_par1_CB2_exp[0];      
       paramCB2Exp[iTail].paramsLimitExp2[1][0] = geant3_fit1_par1_CB2_exp[1];  
       paramCB2Exp[iTail].paramsLimitExp2[1][1] = geant3_fit1_par1_CB2_exp[2];    

       paramCB2Exp[iTail].paramsInitialExp2[2] = geant3_fit1_par2_CB2_exp[0];      
       paramCB2Exp[iTail].paramsLimitExp2[2][0] = geant3_fit1_par2_CB2_exp[1];   
       paramCB2Exp[iTail].paramsLimitExp2[2][1] = geant3_fit1_par2_CB2_exp[2];    

       paramCB2Exp[iTail].paramsInitialExp2[3] = geant3_fit1_par3_CB2_exp[0];      
       paramCB2Exp[iTail].paramsLimitExp2[3][0] = geant3_fit1_par3_CB2_exp[1];   
       paramCB2Exp[iTail].paramsLimitExp2[3][1] = geant3_fit1_par3_CB2_exp[2];    
 
//       paramCB2Exp[iTail].paramsInitialVWG[4] = geant3_fit1_par4_CB2_VWG[0];
//       paramCB2Exp[iTail].paramsLimitVWG[4][0] = geant3_fit1_par4_CB2_VWG[1];
//       paramCB2Exp[iTail].paramsLimitVWG[4][1] = geant3_fit1_par4_CB2_VWG[2];

       paramCB2Exp[iTail].paramsVarianceExp2[1] = geant3_fit1_par1_variance_CB2_exp[0];// 5* (1.01616e+03);
       paramCB2Exp[iTail].paramsLimitVarianceExp2[1][0] = geant3_fit1_par1_variance_CB2_exp[1];
       paramCB2Exp[iTail].paramsLimitVarianceExp2[1][1] = geant3_fit1_par1_variance_CB2_exp[2];

       paramCB2Exp[iTail].paramsVarianceExp2[2] = geant3_fit1_par2_variance_CB2_exp[0]; 
       paramCB2Exp[iTail].paramsLimitVarianceExp2[2][0] = geant3_fit1_par2_variance_CB2_exp[1];
       paramCB2Exp[iTail].paramsLimitVarianceExp2[2][1] = geant3_fit1_par2_variance_CB2_exp[2];

       paramCB2Exp[iTail].paramsVarianceExp2[3] = geant3_fit1_par3_variance_CB2_exp[0];
       paramCB2Exp[iTail].paramsLimitVarianceExp2[3][0] = geant3_fit1_par3_variance_CB2_exp[1];
       paramCB2Exp[iTail].paramsLimitVarianceExp2[3][1] = geant3_fit1_par3_variance_CB2_exp[2];

       paramCB2Exp[iTail].mean_jpsi = geant3_fit1_mean_jpsi_CB2_exp[0];
       paramCB2Exp[iTail].mean_LowerLimits_jpsi = geant3_fit1_mean_jpsi_CB2_exp[1];
       paramCB2Exp[iTail].mean_UpperLimits_jpsi = geant3_fit1_mean_jpsi_CB2_exp[2];

       paramCB2Exp[iTail].width_jpsi = geant3_fit1_width_jpsi_CB2_exp[0];
       paramCB2Exp[iTail].width_LowerLimits_jpsi = geant3_fit1_width_jpsi_CB2_exp[1];
       paramCB2Exp[iTail].width_UpperLimits_jpsi = geant3_fit1_width_jpsi_CB2_exp[2];

       paramCB2Exp[iTail].Norm_psi2S = geant3_fit1_norm_psi2S_CB2_exp[0];
       paramCB2Exp[iTail].LowerLimits_psi2S = geant3_fit1_norm_psi2S_CB2_exp[1];
       paramCB2Exp[iTail].UpperLimits_psi2S = geant3_fit1_norm_psi2S_CB2_exp[2];
      ...
      for (int iCent=0; iCent < 1; iCent++)
      {
        ...
        TF1 *fitFuncCB2Exp = new TF1(Form("%s",paramCB2Exp[iTail].strNameOfFitFunc.Data()), fitFunctionDoubleCB2Exp, FitRange[iRange][0], FitRange[iRange][1], numOfCB2Exp_Param+1);

        TF1 *fitExp = new TF1("fitExp", BackgroundExp, FitRange[iRange][0], FitRange[iRange][1], numOfExp_Parm);

        TF1 *fitEXPreject = new TF1("fitEXPreject",
                              BackgroundEXPreject_JPsi_Psi2S,
                              FitRange[iRange][0],
                              FitRange[iRange][1],
                              numOfExp_Parm);
...
//                      histoInvMass_Pt12to15, 
                      ...
                      fitCB2_Psi2S,
                      paramCB2Exp[iTail],
                      Njpsi_CB2Exp[iRange][iTail],
                      SigmaJpsi_CB2Exp[iRange][iTail],
                      MassJpsi_CB2Exp[iRange][iTail],
                      ChiJpsi_CB2Exp[iRange][iTail],
                      ErrorOfNjpsi_CB2Exp[iRange][iTail],
                      ErrorOfSigmaJpsi_CB2Exp[iRange][iTail],
                      ErrorOfMassJpsi_CB2Exp[iRange][iTail],
                      ErrorOfChiJpsi_CB2Exp[iRange][iTail],
                      fitCanvas_CB2background[iCount1],
//                      fitCanvas_CB2,
//                      fitCanvas_background[iCount1],
                      outcome_fit);

//                      std::cout << "num jpsi: " << outcome_fit.Njpsi_CB2Exp << std::endl;
                      std::cout << "fit validation: " << outcome_fit.fit_valide << std::endl;
                      std::cout << "fit status: " << outcome_fit.fit_status << std::endl;
                      std::cout << "fit covariant matrix: " << outcome_fit.fit_cov_matrix_status << std::endl;

          fit_valide_CB2Exp[iRange][iTail][0] = outcome_fit.fit_valide;
          fit_status_CB2Exp[iRange][iTail][0] = outcome_fit.fit_status;
          fit_cov_matrix_status_CB2Exp[iRange][iTail][0] = outcome_fit.fit_cov_matrix_status;
...
//  paramNA60Pol2[1].strNameOfFitFunc = "fitFuncNA60Pol2_geant3";
  ...
  struct paramOfFunc paramNA60Exp[NUMOFTAILPARAM_NA60];
  paramNA60Exp[0].strNameOfFitFunc = "fitFuncNA60Exp_geant3";
  ...
  for (int iTail=0; iTail < NUMOFTAILPARAM_NA60; iTail++)
  {
    ...
    // NA60 + Exp2
    paramNA60Exp[iTail].binWidth = binWidth;
    paramNA60Exp[iTail].NumOfBackGroundFuncParams = numOfExp_Parm;
    paramNA60Exp[iTail].NumOfJPsiSignalFuncParams = numOfNA60_Parm+1;

    paramNA60Exp[iTail].NameOfBackGroundFuncParams = new TString[numOfExp_Parm];
    for (int iName=0; iName<numOfExp_Parm; iName++) paramNA60Exp[iTail].NameOfBackGroundFuncParams[iName].Append(NameOfExpFuncParams[iName].Data());

    paramNA60Exp[iTail].NameOfJPsiSignalFuncParams = new TString[numOfNA60_Parm+1];
    for (int iName=0; iName<numOfNA60_Parm+1; iName++) paramNA60Exp[iTail].NameOfJPsiSignalFuncParams[iName].Append(NameOfDoubleNA60FuncParams[iName].Data());

    paramNA60Exp[iTail].ParamJPsiFunc = new double[numOfNA60_Parm+1];
  }
...
//    paramNA60Pol2[1].ParamJPsiFunc[iParam] = Param_doubleNA60_geant3[iParam];
    paramNA60Exp[0].ParamJPsiFunc[iParam] = Param_doubleNA60_geant3[iParam];
  }
  ...
  double Njpsi_NA60Exp[FITRANGE][NUMOFTAILPARAM_NA60][NUMOFCENT_BINS];
  double SigmaJpsi_NA60Exp[FITRANGE][NUMOFTAILPARAM_NA60][NUMOFCENT_BINS];
  double MassJpsi_NA60Exp[FITRANGE][NUMOFTAILPARAM_NA60][NUMOFCENT_BINS];
  double ChiJpsi_NA60Exp[FITRANGE][NUMOFTAILPARAM_NA60][NUMOFCENT_BINS];
  double ErrorOfNjpsi_NA60Exp[FITRANGE][NUMOFTAILPARAM_NA60][NUMOFCENT_BINS];
  double ErrorOfSigmaJpsi_NA60Exp[FITRANGE][NUMOFTAILPARAM_NA60][NUMOFCENT_BINS];
  double ErrorOfMassJpsi_NA60Exp[FITRANGE][NUMOFTAILPARAM_NA60][NUMOFCENT_BINS];
  double ErrorOfChiJpsi_NA60Exp[FITRANGE][NUMOFTAILPARAM_NA60][NUMOFCENT_BINS];

  const int FIT_NUMBER_NA60 = FITRANGE * NUMOFBACKGROUNDFUNC*  NUMOFTAILPARAM_NA60 * 1 ;
...
for (int iRange=0; iRange < FITRANGE; iRange++ )
  {
    for (int iTail=0; iTail < NUMOFTAILPARAM_NA60; iTail++)
    {
      const int numOfNA60Exp_Param = numOfExp_Parm + numOfNA60_Parm;
//      for (int iCent=0; iCent < NUMOFCENT_BINS; iCent++)      
    if(iTail==0 && iRange == 0) // Geant4 2.0 - 4.8
    {
      for(int iParam=0; iParam<numOfNA60_Parm; iParam++) paramNA60Exp[iTail].ParamJPsiFunc[iParam] = values_geant3_NA60_tail_range00[pt_bin][iParam];

      paramNA60Exp[iTail].paramsInitialExp2[0]= geant3_fit0_par0_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitExp2[0][0] = geant3_fit0_par0_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitExp2[0][1] = geant3_fit0_par0_NA60_exp[2];

      paramNA60Exp[iTail].paramsInitialExp2[1] = geant3_fit0_par1_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitExp2[1][0] = geant3_fit0_par1_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitExp2[1][1] = geant3_fit0_par1_NA60_exp[2];

      paramNA60Exp[iTail].paramsInitialExp2[2] = geant3_fit0_par2_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitExp2[2][0] = geant3_fit0_par2_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitExp2[2][1] = geant3_fit0_par2_NA60_exp[2];

      paramNA60Exp[iTail].paramsInitialExp2[3] = geant3_fit0_par3_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitExp2[3][0] = geant3_fit0_par3_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitExp2[3][1] = geant3_fit0_par3_NA60_exp[2];

      paramNA60Exp[iTail].paramsVarianceExp2[0] = geant3_fit0_par0_variance_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[0][0] = geant3_fit0_par0_variance_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[0][1] = geant3_fit0_par0_variance_NA60_exp[2];

      paramNA60Exp[iTail].paramsVarianceExp2[1] = geant3_fit0_par1_variance_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[1][0]=geant3_fit0_par1_variance_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[1][1]=geant3_fit0_par1_variance_NA60_exp[2];

      paramNA60Exp[iTail].paramsVarianceExp2[2] = geant3_fit0_par2_variance_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[2][0]=geant3_fit0_par2_variance_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[2][1]=geant3_fit0_par2_variance_NA60_exp[2];

      paramNA60Exp[iTail].paramsVarianceExp2[3] = geant3_fit0_par3_variance_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[3][0]=geant3_fit0_par3_variance_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[3][1]=geant3_fit0_par3_variance_NA60_exp[2];


      paramNA60Exp[iTail].mean_jpsi = geant3_fit0_mean_jpsi_NA60_exp[0];
      paramNA60Exp[iTail].mean_LowerLimits_jpsi = geant3_fit0_mean_jpsi_NA60_exp[1];
      paramNA60Exp[iTail].mean_UpperLimits_jpsi = geant3_fit0_mean_jpsi_NA60_exp[2];
 
      paramNA60Exp[iTail].width_jpsi = geant3_fit0_width_jpsi_NA60_exp[0];
      paramNA60Exp[iTail].width_LowerLimits_jpsi = geant3_fit0_width_jpsi_NA60_exp[1];
      paramNA60Exp[iTail].width_UpperLimits_jpsi = geant3_fit0_width_jpsi_NA60_exp[2];

      paramNA60Exp[iTail].Norm_psi2S = geant3_fit0_norm_psi2S_NA60_exp[0];
      paramNA60Exp[iTail].LowerLimits_psi2S = geant3_fit0_norm_psi2S_NA60_exp[1];
      paramNA60Exp[iTail].UpperLimits_psi2S = geant3_fit0_norm_psi2S_NA60_exp[2];
    ...
    if(iTail==0 && iRange == 1)
    {
      ...
      paramNA60Exp[iTail].paramsInitialExp2[0]= geant3_fit1_par0_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitExp2[0][0] = geant3_fit1_par0_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitExp2[0][1] = geant3_fit1_par0_NA60_exp[2];

      paramNA60Exp[iTail].paramsInitialExp2[1] = geant3_fit1_par1_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitExp2[1][0] = geant3_fit1_par1_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitExp2[1][1] = geant3_fit1_par1_NA60_exp[2];

      paramNA60Exp[iTail].paramsInitialExp2[2] = geant3_fit1_par2_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitExp2[2][0] = geant3_fit1_par2_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitExp2[2][1] = geant3_fit1_par2_NA60_exp[2];

      paramNA60Exp[iTail].paramsInitialExp2[3] = geant3_fit1_par3_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitExp2[3][0] = geant3_fit1_par3_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitExp2[3][1] = geant3_fit1_par3_NA60_exp[2];

      paramNA60Exp[iTail].paramsVarianceExp2[0] = geant3_fit1_par0_variance_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[0][0] = geant3_fit1_par0_variance_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[0][1] = geant3_fit1_par0_variance_NA60_exp[2];

      paramNA60Exp[iTail].paramsVarianceExp2[1] = geant3_fit1_par1_variance_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[1][0]=geant3_fit1_par1_variance_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[1][1]=geant3_fit1_par1_variance_NA60_exp[2];

      paramNA60Exp[iTail].paramsVarianceExp2[2] = geant3_fit1_par2_variance_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[2][0]=geant3_fit1_par2_variance_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[2][1]=geant3_fit1_par2_variance_NA60_exp[2];

      paramNA60Exp[iTail].paramsVarianceExp2[3] = geant3_fit1_par3_variance_NA60_exp[0];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[3][0] = geant3_fit1_par3_variance_NA60_exp[1];
      paramNA60Exp[iTail].paramsLimitVarianceExp2[3][1] = geant3_fit1_par3_variance_NA60_exp[2];


      paramNA60Exp[iTail].mean_jpsi = geant3_fit1_mean_jpsi_NA60_exp[0];
      paramNA60Exp[iTail].mean_LowerLimits_jpsi = geant3_fit1_mean_jpsi_NA60_exp[1];
      paramNA60Exp[iTail].mean_UpperLimits_jpsi = geant3_fit1_mean_jpsi_NA60_exp[2];
 
      paramNA60Exp[iTail].width_jpsi = geant3_fit1_width_jpsi_NA60_exp[0];
      paramNA60Exp[iTail].width_LowerLimits_jpsi = geant3_fit1_width_jpsi_NA60_exp[1];
      paramNA60Exp[iTail].width_UpperLimits_jpsi = geant3_fit1_width_jpsi_NA60_exp[2];

      paramNA60Exp[iTail].Norm_psi2S = geant3_fit1_norm_psi2S_NA60_VWG[0];
      paramNA60Exp[iTail].LowerLimits_psi2S = geant3_fit1_norm_psi2S_NA60_VWG[1];
      paramNA60Exp[iTail].UpperLimits_psi2S = geant3_fit1_norm_psi2S_NA60_VWG[2];
 
    }

      for (int iCent=0; iCent < 1; iCent++)
      {
        TF1 *fitFuncNA60Exp =  new TF1(paramNA60Exp[iTail].strNameOfFitFunc.Data(),
                                      fitFunctionDoubleNA60Exp,
                                      FitRange[iRange][0],
                                      FitRange[iRange][1],
                                      numOfNA60Exp_Param+1);

        TF1 *fitExp = new TF1("fitExp",
                              BackgroundExp,
                              FitRange[iRange][0],
                              FitRange[iRange][1],
                              numOfExp_Parm);
...
//                histoInvMass_Pt12to15,
                ...
                fitNA60_Psi2S,
                paramNA60Exp[iTail],
                Njpsi_NA60Exp[iRange][iTail],
                SigmaJpsi_NA60Exp[iRange][iTail],
                MassJpsi_NA60Exp[iRange][iTail],
                ChiJpsi_NA60Exp[iRange][iTail],
                ErrorOfNjpsi_NA60Exp[iRange][iTail],
                ErrorOfSigmaJpsi_NA60Exp[iRange][iTail],
                ErrorOfMassJpsi_NA60Exp[iRange][iTail],
                ErrorOfChiJpsi_NA60Exp[iRange][iTail],
                fitCanvas_NA60background[iCount1],
//                fitCanvas_background02[iCount1],
                outcome_fit);
          ...
          fit_valide_NA60Exp[iRange][iTail][0] = outcome_fit.fit_valide;
          fit_status_NA60Exp[iRange][iTail][0] = outcome_fit.fit_status;
          fit_cov_matrix_status_NA60Exp[iRange][iTail][0] = outcome_fit.fit_cov_matrix_status;
...
//        delete fitNA60;
  ...
  for(int ifit=0; ifit< (FIT_NUMBER_CB2-4); ifit++) 
  {
...
//    else if(ifit==(FIT_NUMBER_CB2-1))   fitCanvas[ifit]->Print(saveName_2[2].Data());
  ...
  for(int ifit=0; ifit<(FIT_NUMBER_NA60-2); ifit++) 
  {
...
//    if(ifit==(FIT_NUMBER_NA60-1))   fitCanvas_NA60background[ifit]->Print(saveName_2[2].Data());
    fitCanvas_NA60background[ifit]->Print(saveName_2[1].Data());
  }

  for(int ifit=(FIT_NUMBER_CB2-4); ifit<(FIT_NUMBER_CB2); ifit++) 
  {
     fitCanvas_CB2background[ifit]->Print(saveName_2[1].Data());
  }
  for(int ifit= (FIT_NUMBER_NA60-2); ifit<(FIT_NUMBER_NA60); ifit++) 
  {
    if(ifit==(FIT_NUMBER_NA60-1))   fitCanvas_NA60background[ifit]->Print(saveName_2[2].Data());
...
//  histo_NJpsifitUncertainty->GetXaxis()->SetLabelSize(0);
  ...
  TString BackGroundFunc[NUMOFBACKGROUNDFUNC] = {""};

  if(NUMOFBACKGROUNDFUNC==2) 
  {
    BackGroundFunc[0] = Form("VWG");
    BackGroundFunc[1] = Form("polRatio");
  }
  else if(NUMOFBACKGROUNDFUNC==3)
  {
    BackGroundFunc[0] = Form("VWG");
    BackGroundFunc[1] = Form("polRatio");
    BackGroundFunc[2] = Form("Exp");
  }
...
//    for (int iCent=0; iCent < NUMOFCENT_BINS; iCent++)
      for (int iCent=0; iCent < 1; iCent++)
      {
       ...
       if( fit_cov_matrix_status_CB2VWG[iRange][iTail][0] == 2)
       {
         Njpsi_CB2VWG[iRange][iTail][iCent] = 0;
         ErrorOfNjpsi_CB2VWG[iRange][iTail][iCent] = 0;

         MassJpsi_CB2VWG[iRange][iTail][iCent] = 0;
         ErrorOfMassJpsi_CB2VWG[iRange][iTail][iCent] = 0;

         SigmaJpsi_CB2VWG[iRange][iTail][iCent] = 0;
         ErrorOfSigmaJpsi_CB2VWG[iRange][iTail][iCent] = 0;

         ChiJpsi_CB2VWG[iRange][iTail][iCent] = 0;
       }
...
//       else histo_fit_valide->SetBinContent(iCount, 1);
     ...
     total_numberOfJPsi += 0.99*Njpsi_CB2VWG[iRange][iTail][iCent];
     total_error_numberOfJPsi += 0.99*ErrorOfNjpsi_CB2VWG[iRange][iTail][iCent];
...
//    for (int iCent=0; iCent < NUMOFCENT_BINS; iCent++)
      for (int iCent=0; iCent < 1; iCent++)
      {
       ...
       if( fit_cov_matrix_status_CB2Pol[iRange][iTail][0] == 2)
       {
         Njpsi_CB2Pol2[iRange][iTail][iCent] = 0;
         ErrorOfNjpsi_CB2Pol2[iRange][iTail][iCent] = 0;

         MassJpsi_CB2Pol2[iRange][iTail][iCent] = 0;
         ErrorOfMassJpsi_CB2Pol2[iRange][iTail][iCent] = 0;

         SigmaJpsi_CB2Pol2[iRange][iTail][iCent] = 0;
         ErrorOfSigmaJpsi_CB2Pol2[iRange][iTail][iCent] = 0;

         ChiJpsi_CB2Pol2[iRange][iTail][iCent] = 0;
       }
...
//       else histo_fit_valide->SetBinContent(iCount, 1);
     ...
     numberOfJPsi[iCount-1] = 0.99*Njpsi_CB2Pol2[iRange][iTail][iCent];
     error_numberOfJPsi[iCount-1] = 0.99*ErrorOfNjpsi_CB2Pol2[iRange][iTail][iCent];
...
//    for (int iCent=0; iCent < NUMOFCENT_BINS; iCent++)
      for (int iCent=0; iCent < 1; iCent++)
      {
        ...
        if( fit_cov_matrix_status_NA60VWG[iRange][iTail][0] == 2)
        {
           Njpsi_NA60VWG[iRange][iTail][iCent] = 0;
           ErrorOfNjpsi_NA60VWG[iRange][iTail][iCent] = 0;

           MassJpsi_NA60VWG[iRange][iTail][iCent] = 0;
           ErrorOfMassJpsi_NA60VWG[iRange][iTail][iCent] = 0;

           SigmaJpsi_NA60VWG[iRange][iTail][iCent] = 0;
           ErrorOfSigmaJpsi_NA60VWG[iRange][iTail][iCent] = 0;

           ChiJpsi_NA60VWG[iRange][iTail][iCent] = 0;
         }
...
//       else histo_fit_valide->SetBinContent(iCount, 1);
     ...
     iCount++;
     total_numberOfJPsi += 0.99*Njpsi_NA60VWG[iRange][iTail][iCent];
     total_error_numberOfJPsi += 0.99*ErrorOfNjpsi_NA60VWG[iRange][iTail][iCent];
...
//    for (int iCent=0; iCent < NUMOFCENT_BINS; iCent++)
      for (int iCent=0; iCent < 1; iCent++)
      {
            ...
            if( fit_cov_matrix_status_NA60Pol[iRange][iTail][0] == 2)
            {
               Njpsi_NA60Pol2[iRange][iTail][iCent] = 0;
               ErrorOfNjpsi_NA60Pol2[iRange][iTail][iCent] = 0;

               MassJpsi_NA60Pol2[iRange][iTail][iCent] = 0;
               ErrorOfMassJpsi_NA60Pol2[iRange][iTail][iCent] = 0;

               SigmaJpsi_NA60Pol2[iRange][iTail][iCent] = 0;
               ErrorOfSigmaJpsi_NA60Pol2[iRange][iTail][iCent] = 0;

               ChiJpsi_NA60Pol2[iRange][iTail][iCent] = 0;
            }
...
//       else histo_fit_valide->SetBinContent(iCount, 1);
     ...
     total_numberOfJPsi += 0.99*Njpsi_NA60Pol2[iRange][iTail][iCent];
     total_error_numberOfJPsi += 0.99*ErrorOfNjpsi_NA60Pol2[iRange][iTail][iCent];
...
//    for (int iCent=0; iCent < NUMOFCENT_BINS; iCent++)
      for (int iCent=0; iCent < 1; iCent++)
      {
            xaxis->SetBinLabel(iCount, Form("%s+%s_%s",BackGroundFunc[2].Data(),fitFuncElement_CB2[iTail].Data(), fitRange[iRange].Data()) );
            xaxis_fit_valide->SetBinLabel(iCount, Form("%s+%s_%s",BackGroundFunc[2].Data(),fitFuncElement_CB2[iTail].Data(), fitRange[iRange].Data()) );
            xaxis_fit_status->SetBinLabel(iCount, Form("%s+%s_%s",BackGroundFunc[2].Data(),fitFuncElement_CB2[iTail].Data(), fitRange[iRange].Data()) );
            xaxis_cov_matrix_status->SetBinLabel(iCount, Form("%s+%s_%s",BackGroundFunc[2].Data(),fitFuncElement_CB2[iTail].Data(), fitRange[iRange].Data()) );

       if( fit_cov_matrix_status_CB2Exp[iRange][iTail][0] == 2)
       {
         Njpsi_CB2Exp[iRange][iTail][iCent] = 0;
         ErrorOfNjpsi_CB2Exp[iRange][iTail][iCent] = 0;

         MassJpsi_CB2Exp[iRange][iTail][iCent] = 0;
         ErrorOfMassJpsi_CB2Exp[iRange][iTail][iCent] = 0;

         SigmaJpsi_CB2Exp[iRange][iTail][iCent] = 0;
         ErrorOfSigmaJpsi_CB2Exp[iRange][iTail][iCent] = 0;

         ChiJpsi_CB2Exp[iRange][iTail][iCent] = 0;
       }


       std::cout<<"count: " << iCount<<std::endl;
       histo_NJpsifitUncertainty->SetBinContent(iCount, Njpsi_CB2Exp[iRange][iTail][iCent]);
       histo_NJpsifitUncertainty->SetBinError(iCount, ErrorOfNjpsi_CB2Exp[iRange][iTail][iCent]);
       histo_SigmaJpsifitUncertainty->SetBinContent(iCount,SigmaJpsi_CB2Exp[iRange][iTail][iCent] );
       histo_SigmaJpsifitUncertainty->SetBinError(iCount,ErrorOfSigmaJpsi_CB2Exp[iRange][iTail][iCent]);
       histo_MassJpsifitUncertainty->SetBinContent(iCount, MassJpsi_CB2Exp[iRange][iTail][iCent]);
       histo_MassJpsifitUncertainty->SetBinError(iCount, ErrorOfMassJpsi_CB2Exp[iRange][iTail][iCent]);
       histo_ChiJpsifitUncertainty->SetBinContent(iCount, ChiJpsi_CB2Exp[iRange][iTail][iCent] );

//       if(fit_valide_CB2Pol[iRange][iTail][0]) histo_fit_valide->SetBinContent(iCount, 0);
//       else histo_fit_valide->SetBinContent(iCount, 1);
       histo_fit_valide->SetBinContent(iCount, fit_valide_CB2Exp[iRange][iTail][0]);
       histo_fit_status->SetBinContent(iCount, fit_status_CB2Exp[iRange][iTail][0]);
       histo_cov_matrix_status->SetBinContent(iCount, fit_cov_matrix_status_CB2Exp[iRange][iTail][0]);       




     std::cout<<"Num Jpsi: "<<Njpsi_CB2Exp[iRange][iTail][iCent];
     std::cout<<" +- "<<ErrorOfNjpsi_CB2Exp[iRange][iTail][iCent] << std::endl;

     std::cout<<"Mass Jpsi: "<<MassJpsi_CB2Exp[iRange][iTail][iCent];
     std::cout<<" +- "<<ErrorOfMassJpsi_CB2Exp[iRange][iTail][iCent] <<std::endl;

     std::cout<<"Sigma Jpsi: "<< SigmaJpsi_CB2Exp[iRange][iTail][iCent];
     std::cout<<" +- "<<ErrorOfSigmaJpsi_CB2Exp[iRange][iTail][iCent] <<std::endl;

     std::cout<<"Chi2: " << ChiJpsi_CB2Exp[iRange][iTail][iCent] <<std::endl;
 
     numberOfJPsi[iCount-1] = Njpsi_CB2Exp[iRange][iTail][iCent];
     error_numberOfJPsi[iCount-1] = ErrorOfNjpsi_CB2Exp[iRange][iTail][iCent];
     sigmaOfJPsi[iCount-1]=SigmaJpsi_CB2Exp[iRange][iTail][iCent];
     error_sigmaOfJPsi[iCount-1] = ErrorOfSigmaJpsi_CB2Exp[iRange][iTail][iCent];
     massOfJPsi[iCount-1]   = MassJpsi_CB2Exp[iRange][iTail][iCent];

     iCount++;

     total_numberOfJPsi += Njpsi_CB2Exp[iRange][iTail][iCent];
     total_error_numberOfJPsi += ErrorOfNjpsi_CB2Exp[iRange][iTail][iCent];
     total_sigmaOfJPsi  += SigmaJpsi_CB2Exp[iRange][iTail][iCent];
     total_massOfJPsi   += MassJpsi_CB2Exp[iRange][iTail][iCent];      
     //std::cout<<"total Num Jpsi: " << total_numberOfJPsi << std::endl;
      } // end of for (int iCent=0; iCent < 1; iCent++)  
    } // end of for (int iTail=0; iTail< NUMOFTAILPARAM_CB2; iTail++)
  }  // end of for (iRange=0; iRange < 2; iRange++ )
...
//    for (int iCent=0; iCent < NUMOFCENT_BINS; iCent++)
      for (int iCent=0; iCent < 1; iCent++)
      {
           xaxis->SetBinLabel(iCount, Form("%s+%s_%s",BackGroundFunc[2].Data(),fitFuncElement_NA60[iTail].Data(), fitRange[iRange].Data()) );
           xaxis_fit_valide->SetBinLabel(iCount, Form("%s+%s_%s",BackGroundFunc[2].Data(),fitFuncElement_NA60[iTail].Data(), fitRange[iRange].Data()) );
            xaxis_fit_status->SetBinLabel(iCount, Form("%s+%s_%s",BackGroundFunc[2].Data(),fitFuncElement_NA60[iTail].Data(), fitRange[iRange].Data()) );
            xaxis_cov_matrix_status->SetBinLabel(iCount, Form("%s+%s_%s",BackGroundFunc[2].Data(),fitFuncElement_NA60[iTail].Data(), fitRange[iRange].Data()) );

          if( fit_cov_matrix_status_NA60Exp[iRange][iTail][0] == 2)
          {
            Njpsi_NA60Exp[iRange][iTail][iCent] = 0;
            ErrorOfNjpsi_NA60Exp[iRange][iTail][iCent] = 0;

            MassJpsi_NA60Exp[iRange][iTail][iCent] = 0;
            ErrorOfMassJpsi_NA60Exp[iRange][iTail][iCent] = 0;

            SigmaJpsi_NA60Exp[iRange][iTail][iCent] = 0;
            ErrorOfSigmaJpsi_NA60Exp[iRange][iTail][iCent] = 0;

            ChiJpsi_NA60Exp[iRange][iTail][iCent] = 0;
          }


     std::cout<<"count: " << iCount<<std::endl;
     histo_NJpsifitUncertainty->SetBinContent(iCount, Njpsi_NA60Exp[iRange][iTail][iCent]);
     histo_NJpsifitUncertainty->SetBinError(iCount, ErrorOfNjpsi_NA60Exp[iRange][iTail][iCent]);
     histo_SigmaJpsifitUncertainty->SetBinContent(iCount,SigmaJpsi_NA60Exp[iRange][iTail][iCent] );
     histo_SigmaJpsifitUncertainty->SetBinError(iCount,ErrorOfSigmaJpsi_NA60Exp[iRange][iTail][iCent]);
     histo_MassJpsifitUncertainty->SetBinContent(iCount, MassJpsi_NA60Exp[iRange][iTail][iCent]);
     histo_MassJpsifitUncertainty->SetBinError(iCount, ErrorOfMassJpsi_NA60Exp[iRange][iTail][iCent]);
     histo_ChiJpsifitUncertainty->SetBinContent(iCount, ChiJpsi_NA60Exp[iRange][iTail][iCent] );

//       if(fit_valide_NA60Pol[iRange][iTail][0]) histo_fit_valide->SetBinContent(iCount, 0);
//       else histo_fit_valide->SetBinContent(iCount, 1);
       histo_fit_valide->SetBinContent(iCount, fit_valide_NA60Exp[iRange][iTail][0]);
       histo_fit_status->SetBinContent(iCount, fit_status_NA60Exp[iRange][iTail][0]);
       histo_cov_matrix_status->SetBinContent(iCount, fit_cov_matrix_status_NA60Exp[iRange][iTail][0]); 



     std::cout<<"Num Jpsi: "<<Njpsi_NA60Exp[iRange][iTail][iCent];
     std::cout<<" +- "<<ErrorOfNjpsi_NA60Exp[iRange][iTail][iCent] << std::endl;

     std::cout<<"Mass Jpsi: "<<MassJpsi_NA60Exp[iRange][iTail][iCent];
     std::cout<<" +- "<<ErrorOfMassJpsi_NA60Exp[iRange][iTail][iCent] <<std::endl;

     std::cout<<"Sigma Jpsi: "<< SigmaJpsi_NA60Exp[iRange][iTail][iCent];
     std::cout<<" +- "<<ErrorOfSigmaJpsi_NA60Exp[iRange][iTail][iCent] <<std::endl;

     std::cout<<"Chi2: " << ChiJpsi_NA60Exp[iRange][iTail][iCent] <<std::endl;
     
     numberOfJPsi[iCount-1] = Njpsi_NA60Exp[iRange][iTail][iCent];
     error_numberOfJPsi[iCount-1] = ErrorOfNjpsi_NA60Exp[iRange][iTail][iCent];
     sigmaOfJPsi[iCount-1]=SigmaJpsi_NA60Exp[iRange][iTail][iCent];
     error_sigmaOfJPsi[iCount-1] = ErrorOfSigmaJpsi_NA60Exp[iRange][iTail][iCent];
     massOfJPsi[iCount-1]   = MassJpsi_NA60Exp[iRange][iTail][iCent];
     iCount++;

     total_numberOfJPsi += Njpsi_NA60Exp[iRange][iTail][iCent];
     total_error_numberOfJPsi += ErrorOfNjpsi_NA60Exp[iRange][iTail][iCent];
     total_sigmaOfJPsi  += SigmaJpsi_NA60Exp[iRange][iTail][iCent];
     total_massOfJPsi   += MassJpsi_NA60Exp[iRange][iTail][iCent];
     std::cout<<"total Num Jpsi: " << total_numberOfJPsi << std::endl;
      } // end of for (int iCent=0; iCent < 1; iCent++)  
    } // end of for (int iTail=0; iTail< NUMOFTAILPARAM_CB2; iTail++)
  }  // end of for (iRange=0; iRange < 2; iRange++ )
 ...
 */
  ...
  // the weight including the pp data tail and background function for event mixing

//  double WVALUE[max] = {2,1,2,1,2,1,
//                        2,1,1,1,1,1,
//                        4,2,4,2,2,2};

//  double WVALUE[max] = {2, 1, 2, 1, 0, 0,
//                        0, 1, 1, 1, 1, 0,
//                        2, 1, 2, 0, 0, 1};   // 15 to 20 GeV/c

//   double WVALUE[max] = {1.6, 1, 1.6, 1, 1.6, 1,
//                         0, 0, 1, 1, 0, 0,
//                         1.6, 1, 1.6, 1, 1, 0}; // 12 to 15 GeV/c

//   double WVALUE[max] = {1.8, 1, 1.8, 1, 1.8, 1,
//                         1.8, 1, 1, 1, 1, 1,
//                         0, 0, 1.8, 1, 0, 0}; // 11 to 12 GeV/c

//  double WVALUE[max] = {1.2, 0, 1.2, 1, 0, 1,
//                        1.2, 0, 1, 1, 0, 0,
//                        1.2, 1, 1.2, 1, 0, 1}; // 10 to 11 GeV/c

//  double WVALUE[max] = {1.833, 1, 1.833, 1, 1.833, 1,
//                        1.833, 1, 1, 1, 0, 1,
//                        1.833, 1, 1.833, 1, 1, 1}; // 9 to 10 GeV/c

//  double WVALUE[max] = {1.667, 1, 1.667, 1, 1.667, 1,
//                        1.667, 1, 1, 1, 0, 0,
//                        1.667, 1, 1.667, 1, 1, 1}; // 1 to 2 GeV/c
/* 
  double WVALUE[max] = {2, 1, 2, 1, 0, 1,
                       2, 1, 1, 0, 1, 0,
                        2, 1, 2, 1, 1, 1}; // 2 to 3 GeV/c
*/
 ...
 */
  ...
  double wrms_SigmaJpsi = calWeightRMS((iCount-1), WVALUE, sigmaOfJPsi );
  double wErrorSigmaJpsi = calWeightAverage((iCount-1),  WVALUE, error_sigmaOfJPsi);

  double wAverageMassJpsi = calWeightAverage((iCount-1), WVALUE, massOfJPsi);
  double wrms_MassJpsi = calWeightRMS((iCount-1), WVALUE, massOfJPsi );
  //double wErrorMassJpsi = calWeightAverage((iCount-1),  WVALUE, error_massOfJPsi);

  std::cout << "weighted mean sigma of jpsi: " << wAverageSigmaJpsi << "+/-" << wErrorSigmaJpsi << std::endl;


  output_text_file.open(Form("jpsi_number.txt"));
  output_text_file << wAverageNJpsi <<"\n";
  output_text_file << wErrorNJpsi << "\n";
  ...
  histo_SigmaJpsifitUncertainty->SetAxisRange(wAverageSigmaJpsi-display_Sigma_range, wAverageSigmaJpsi + display_Sigma_range,"Y");
  histo_MassJpsifitUncertainty->SetAxisRange(wAverageMassJpsi-display_Mass_range, wAverageMassJpsi+display_Mass_range,"Y");
...
//  t2->AddText(0.,0.,Form("%.1f <p_{T}< %.1f GeV/c N_{J/#psi} = %.0f #pm %.0f (stat) #pm %.0f (sys)", arrayAvailablePtBins_photon[pt_bin], arrayAvailablePtBins_photon[pt_bin+1], wAverageNJpsi,wErrorNJpsi, wrms ));
  t2->AddText(0.,0.,Form("%s GeV/c N_{J/#psi} = %.0f #pm %.0f (stat) #pm %.0f (sys)", tstr_pt_bin.Data(), wAverageNJpsi,wErrorNJpsi, wrms ));
...
//  t2->AddText(0.,0.,Form("average width %0.5f",averageSigmaJPsi) );
  ...
  line_rms_sigma[0]->DrawLine(0,wrms_SigmaJpsi+ wAverageSigmaJpsi, (max+1), wrms_SigmaJpsi+wAverageSigmaJpsi);
  line_rms_sigma[1]->DrawLine(0,-1*wrms_SigmaJpsi+ wAverageSigmaJpsi, (max+1), -1*wrms_SigmaJpsi+ wAverageSigmaJpsi);
...
//  legend->SetTextSize(0.04);
  ...
  line_rms_mass[0]->DrawLine(0, wrms_MassJpsi+wAverageMassJpsi, (max+1), wrms_MassJpsi+wAverageMassJpsi );
  line_rms_mass[1]->DrawLine(0, -1*wrms_MassJpsi+wAverageMassJpsi, (max+1), -1*wrms_MassJpsi+wAverageMassJpsi );
...
//    fitFunc->SetParLimits(5,parameters.paramsLimitVWG[5][0],parameters.paramsLimitVWG[5][1]);
  ...
  if(parameters.NumOfBackGroundFuncParams==4 )
  {
    backgroundFuncReject->SetParameter(0,(parameters.paramsInitialExp2[0])*histo->GetMaximum());
    backgroundFuncReject->SetParLimits(0,parameters.paramsLimitExp2[0][0],parameters.paramsLimitExp2[0][1]);

    backgroundFuncReject->SetParameter(1,(parameters.paramsInitialExp2[1]));
    backgroundFuncReject->SetParLimits(1,parameters.paramsLimitExp2[1][0],parameters.paramsLimitExp2[1][1]);

    backgroundFuncReject->SetParameter(2, (parameters.paramsInitialExp2[2]) );
    backgroundFuncReject->SetParLimits(2,parameters.paramsLimitExp2[2][0],parameters.paramsLimitExp2[2][1]);

    backgroundFuncReject->SetParameter(3, (parameters.paramsInitialExp2[3]) );
    backgroundFuncReject->SetParLimits(3,parameters.paramsLimitExp2[3][0],parameters.paramsLimitExp2[3][1]);
 
    histo->Fit("fitEXPreject", Form("%s",opt2.Data() )); 
...
*/
    ...
    fitFunc->SetParameter(parameters.NumOfBackGroundFuncParams, histo->GetMaximum());
    fitFunc->SetParLimits(parameters.NumOfBackGroundFuncParams, 0, (parameters.paramsLimitExp[0][1])*histo->GetMaximum()); 
...
//  fitFunc->SetParLimits((totalFuncParams-1), 0, histo->GetMaximum()/2.0 );
  ...
  if(parameters.NumOfBackGroundFuncParams==4 )
  {
    tfitResult = histo->Fit( parameters.strNameOfFitFunc.Data(),Form("%s",opt2.Data() ));
  }
  else
  { 
