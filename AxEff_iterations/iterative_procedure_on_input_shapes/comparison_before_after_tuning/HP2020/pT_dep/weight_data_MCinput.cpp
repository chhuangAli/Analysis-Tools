...
//
  ...
  TString ReadFileLocation = Form("$HOME/cernbox/AnaSourceCode/anaJPsi_2015_2018PbPb/AxEff/cent_dep_tuning_input_shapes/Raw_data/Jpsi_yield/HP2020/pT_dep/original_input_shape/JpsiYieldsHistos.root");
...
//
  ...
  ReadFileLocation = Form("$HOME/cernbox/AnaSourceCode/anaJPsi_2015_2018PbPb/AxEff/cent_dep_tuning_input_shapes/MC_input/HP2020/pT_dep/original_input_shape/JpsiMCinputHistos.root");
//  ReadFileLocation = Form("$HOME/cernbox/AnaSourceCode/anaJPsi_2015_2018PbPb/AxEff/cent_dep_tuning_input_shapes/MC_input/HP2020/pT_dep/one_tuning/JpsiMCinputHistos.root");
...
//    gr_ratio-
  ...
  TH2F *hratio = new TH2F("hratio","",100,0,20,100, 0.4, 2.);
  hratio->SetStats(0);
...
//  leg2->AddEntry(gr_dNdpT_syst,"Systematic uncertainty","F");
  ...
  if(iCent == 0)
  {
    c2->Print("dN_dpT_over_Ae_cent0to10.pdf");
  }
  else if(iCent == 1)
  {
    c2->Print("dN_dpT_over_Ae_cent10to20.pdf");
  }
  else if(iCent == 2)
  {
    c2->Print("dN_dpT_over_Ae_cent20to30.pdf");
  }
  else if(iCent == 3)
  {
    c2->Print("dN_dpT_over_Ae_cent30to40.pdf");
  }
  else if(iCent == 4)
  {
    c2->Print("dN_dpT_over_Ae_cent40to90.pdf");
  }
