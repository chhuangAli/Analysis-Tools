...
//  float y_bin[]= {2.5, 2.75, 3.0, 3.25, 3.5, 3.75, 4};
  ...
  TFile *outputFile = new TFile(Form("/home/chunlu/local/anaedPbPbSimData2016/LHC16e2_jpsi_ttree/CINTEvent_MCinput_weight_AnaResults/PbPbMC_ResultsHistos_Run%d.root",RunNumber),"recreate");
...
//
//  Create directories to be saved in the output file
//
...
//              histoRapidity->Sumw2();
   ...
   double par0_gen_pt_0to10[] = {1474527.64, 3.4930, 1.9345, 3.9511, -863.9616, 0.3488};
   double par0_rec_pt_0to10[] = {1030488.07, 2.8523, 2.8069, 2.4245,  215942.0671, 0.6826};

   double par0_gen_pt_10to20[] = {886965.35, 3.4677, 1.9447, 3.9065, 634.1082, 0.4650};
   double par0_rec_pt_10to20[] = {595607.92, 2.9429, 2.6693, 2.5015, 129315.9179, 0.6354};

   double par0_gen_y_0to10[] = {5352907.37, -0.1145, 2.0858};
   double par0_rec_y_0to10[] = {2448415.92, -2.4193, 1.0950};

   double par0_gen_y_10to20[] = {3462830.25, -0.0264, 2.1131};
   double par0_rec_y_10to20[] = {1797334.82, -1.7785, 1.5044};
...
//        std::cout << "weight value:  " << weight_results << "for " << vectorCentBins[centralityBin] <<"-- "<< vectorCentBins[centralityBin+1] << std::endl;
      ...
      {
        weight1_pt = setWeight_Pt(lvDimuon.Pt(), par0_rec_pt_10to20, par0_gen_pt_10to20);
        weight1_y = setWeight_Y(rapidity, par0_rec_y_10to20, par0_gen_y_10to20);
