...
//          inputSimFile = Form("$HOME/local/anaedPbPbSimData2016/LHC16e2_jpsi_ttree/AnalysisResults_run%i.root", LHC15o_run_number[iRun]);
//          inputSimFile2 = Form("$HOME/local/anaedPbPbSimData2016/LHC16e2_plus_jpsi_ttree/AnalysisResults_run%i.root", LHC15o_run_number[iRun]);
...
//          entries_gen_per_run[iCent][iRun] += hPt_gen[iCent][iRun]->Integral(1, 120); // pT = 0-12 GeV/c
        rec += hPt_rec[iCent][iRun]->Integral(1, pTNBins);
        gen += hPt_gen[iCent][iRun]->Integral(1, pTNBins);
      }
  }

  std::cout << "total: " << rec << ", " << gen << std::endl;
