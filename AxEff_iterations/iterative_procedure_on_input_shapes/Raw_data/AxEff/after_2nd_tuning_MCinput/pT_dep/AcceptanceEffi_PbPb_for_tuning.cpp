...
//          inputSimFile2 = Form("$HOME/local/anaedPbPbSimData2016/LHC16e2_plus_with_centrality_class/AnalysisResults_run000%i_MCembedding_LHC16e2_plus.root", LHC15o_run_number[iRun]);
          ...
          inputSimFile = Form("$HOME/local/anaedPbPbSimData2016/LHC16e2_jpsi_ttree/CINTEvent_MCinput_2nd_weight_AnaResults/PbPbMC_ResultsHistos_Run%i.root", LHC15o_run_number[iRun]);
          inputSimFile2 = Form("$HOME/local/anaedPbPbSimData2016/LHC16e2_plus_jpsi_ttree/CINTEvent_MCinput_2nd_weight_AnaResults/PbPbMC_ResultsHistos_Run%i.root", LHC15o_run_number[iRun]);
...
//          std::cout << LHC18q_r_run_number[iRun-LHC15o_NUMOFFILES] << std::endl;
          inputSimFile = Form("$HOME/local/anaedPbPbSim2018/LHC19a2_jpsi_ttree/CINTEvent_MCinput_2nd_weight_AnaResults/PbPbMC_ResultsHistos_Run%i.root",LHC18q_r_run_number[iRun-LHC15o_NUMOFFILES]);
          inputFile = TFile::Open( inputSimFile.Data() );        
        }
        else 
        {
