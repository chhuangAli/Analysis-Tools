...
//  TFile *inputFile2 = new TFile("$HOME/cernbox/AnaSourceCode/anaJPsi_2015_2018PbPb/AxEff/cent_dep_tuning_input_shapes/Raw_data/AxEff/after_tuning_MCinput/AxEff_LHC15o_18q_18r.root","READ");
   TFile *inputFile2 = new TFile("$HOME/cernbox/AnaSourceCode/anaJPsi_2015_2018PbPb/AxEff/cent_dep_tuning_input_shapes/Raw_data/AxEff/AxEff_LHC15o_18q_18r_1st_tuning.root","READ");
//  TFile *inputFile = new TFile("$HOME/cernbox/AnaSourceCode/anaJPsi_2015_2018PbPb/AxEff/cent_dep_tuning_input_shapes/Raw_data/AxEff/AxEff_LHC15o_18q_18r.root","READ");
//  TFile *inputFile2 = new TFile("$HOME/cernbox/AnaSourceCode/anaJPsi_2015_2018PbPb/AxEff/cent_dep_tuning_input_shapes/Raw_data/AxEff/backup_AxEff_LHC15o_18q_18r.root","READ");
...
//  TFile *inputFile2 = new TFile("$HOME/cernbox/AnaSourceCode/anaJPsi_2015_2018PbPb/AxEff/cent_dep_tuning_input_shapes/Raw_data/AxEff/after_2nd_tuning_MCinput/pT_dep/AxEff_LHC15o_18q_18r.root","READ");
  ...
  for(int iCent=0; iCent< max_cent_bin; iCent++ )
  {
    ...
    hAe_Pt_rela_diff[iCent]->Add(hAe_Pt_tuned[iCent], hAe_Pt[iCent], 1.0, -1.0);    
    hAe_Pt_rela_diff[iCent]->Divide(hAe_Pt[iCent]);
    hAe_Pt_rela_diff[iCent]->Scale(100);
    hAe_Pt_rela_diff[iCent]->GetYaxis()->SetTitle("#frac{A#epsilon_{1}-A#epsilon_{0}}{A#epsilon_{0}} %");
    hAe_Pt_rela_diff[iCent]->GetXaxis()->SetTitle("p_{T} (GeV/c)");
  }
  ...
  legend->AddEntry(hAe_Pt[0],"AxEff0","l");
  legend->AddEntry(hAe_Pt_tuned[0],"AxEff1","l");
  legend->Draw();
  ...
  legend->AddEntry(hAe_Pt[1],"AxEff0","l");
  legend->AddEntry(hAe_Pt_tuned[1],"AxEff1","l");
