...
//  float y_bin[] ={2.5,2.75,3,3.25,3.5,3.75,4};
  ...
  TString Njpsi_file_name = "jpsi_number_pp13TeV_VWG_2p2_4p5.txt";
...
//  TString ReadFileLocation = Form("$HOME/cernbox/AnaSourceCode/anaJPsi_2015_2018PbPb/AxEff/cent_dep_tuning_input_shapes/Raw_data/AxEff/after_tuning_MCinput/AxEff_y/AxEff_LHC15o_18q_18r.root");
  ...
  for(int iCent = 0; iCent < (CENTRALITY_TUNING); iCent++)
  {
    hAe_cent_dep[iCent]->Add( (TH1F*)inputFile_AxEff->Get(Form("hAe_cent%ito%i", cent_bin[iCent], cent_bin[iCent+1]) ));
  }
