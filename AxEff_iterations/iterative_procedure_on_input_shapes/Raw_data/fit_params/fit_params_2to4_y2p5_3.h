...
double pp13_fit0_par2_CB2_VWG[] = {0.1,-5.,5.};
double pp13_fit0_par3_CB2_VWG[] = {1,-10.,10.};
double pp13_fit0_par4_CB2_VWG[] = {0.1,-5.,5.};
...
double pp13_fit0_width_jpsi_CB2_VWG[] = {0.07, 0.05, 0.08};
...
//Tail: geant3. Fit Range: 2.2 4.4
double geant3_fit1_par0_CB2_pol[] = {1.,0.,8.}; // initial value, lower limit, upper limit
...
double geant3_fit0_par1_NA60_VWG[] = {1, 0.,50.}; //2.5,0.,8.
double geant3_fit0_par2_NA60_VWG[] = {1, 0.,50.}; // 1.,-5.,5.
double geant3_fit0_par3_NA60_VWG[] = {1, 0.,50.}; // 1.,-5.,5.
double geant3_fit0_par4_NA60_VWG[] = {1, 0.,50.}; // 1.,-5.,5.
...
double geant3_fit0_par4_NA60_pol[] = {1.,-100.,100.};
...
// Tail: geant3. Fit Range: 2.2 4.4
double geant3_fit1_par0_NA60_pol[] = {1.,0.,7.}; // initial value, lower limit, upper limit
