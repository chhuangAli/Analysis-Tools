...
//        inputSimFile3 = Form("$HOME/local/anaedPbPbSim2018/LHC19a2/AnalysisResults_MCembedding_LHC19a2.root");
        inputSimFile3 = ("$HOME/local/anaedPbPbSim2018/LHC19a2_jpsi_ttree/CINTEvent_MCinput_2nd_weight_AnaResults/PbPbMC_ResultsHistos_LHC18q.root");
        inputFile3 = TFile::Open( inputSimFile3.Data() );

        inputSimFile4 = ("$HOME/local/anaedPbPbSim2018/LHC19a2_jpsi_ttree/CINTEvent_MCinput_2nd_weight_AnaResults/PbPbMC_ResultsHistos_LHC18r.root");
